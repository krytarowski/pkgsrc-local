...
+#elif defined(VGO_darwin) || defined(VGO_netbsd)
 /* XXX: Darwin still uses the old scheme of exposing the table
    ...
    fixed. */
@@ -275,7 +284,7 @@ SyscallTableEntry* ML_(get_solaris_sysca
...
+#if defined(VGO_linux) || defined(VGO_solaris) || defined(VGO_netbsd)
 ...
 #elif defined(VGO_darwin)
@@ -290,6 +299,10 @@ SyscallTableEntry* ML_(get_solaris_sysca
...
@@ -335,7 +348,7 @@ static inline UWord getRES ( SyscallStat
...
@@ -356,6 +369,13 @@ static inline UWord getERR ( SyscallStat
...
@@ -419,7 +439,7 @@ static inline UWord getERR ( SyscallStat
