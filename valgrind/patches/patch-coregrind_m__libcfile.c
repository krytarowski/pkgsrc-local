...
@@ -397,7 +406,13 @@ Int VG_(fstat) ( Int fd, struct vg_stat*
    SysRes res;
    VG_(memset)(vgbuf, 0, sizeof(*vgbuf));
...
@@ -469,7 +484,7 @@ Bool VG_(is_dir) ( const HChar* f )
...
@@ -491,7 +506,7 @@ SysRes VG_(dup2) ( Int oldfd, Int newfd 
...
@@ -503,7 +518,7 @@ SysRes VG_(dup2) ( Int oldfd, Int newfd 
 /* Returns -1 on error. */
...
@@ -518,7 +533,7 @@ Int VG_(rename) ( const HChar* old_name,
...
+#  elif defined(VGO_linux) || defined(VGO_darwin) || defined(VGO_netbsd)
 ...
 #  else
 #    error "Unknown OS"
@@ -531,7 +546,7 @@ Int VG_(unlink) ( const HChar* file_name
...
@@ -553,7 +568,7 @@ static HChar *startup_wd;
    changes. */
...
+#  if defined(VGO_linux) || defined(VGO_solaris) || defined(VGO_netbsd)
    ...
    SysRes res;
    SizeT szB = 0;
@@ -561,7 +576,11 @@ void VG_(record_startup_wd) ( void )
       szB += 500;
...
+#    endif
    ...
    if (sr_isError(res)) {
@@ -614,7 +633,7 @@ SysRes VG_(poll) (struct vki_pollfd *fds
                           (UWord)fds, nfds, 
...
@@ -649,7 +668,7 @@ SSizeT VG_(readlink) (const HChar* path,
 #  if defined(VGP_arm64_linux)
...
@@ -727,7 +746,7 @@ Int VG_(access) ( const HChar* path, Boo
              | (ixusr ? VKI_X_OK : 0);
 #  if defined(VGP_arm64_linux)
...
@@ -768,71 +787,113 @@ Int VG_(check_executable)(/*OUT*/Bool* i
...
@@ -872,6 +933,10 @@ SysRes VG_(pread) ( Int fd, void* buf, I
...
@@ -1023,7 +1088,7 @@ UShort VG_(ntohs) ( UShort x )
 */
...
+#  if defined(VGO_linux) || defined(VGO_darwin) || defined(VGO_solaris) || defined(VGO_netbsd)
    ...
    UInt   ip   = 0;
@@ -1124,9 +1189,13 @@ Int VG_(socket) ( Int domain, Int type, 
...
+#    endif
 ...
 #  elif defined(VGO_darwin)
@@ -1179,7 +1248,7 @@ Int my_connect ( Int sockfd, struct vki_
...
+        || defined(VGP_arm64_linux) || defined(VGO_netbsd)
    ...
    return sr_isError(res) ? -1 : sr_Res(res);
@@ -1226,7 +1295,7 @@ Int VG_(write_socket)( Int sd, const voi
...
@@ -1262,7 +1331,7 @@ Int VG_(getsockname) ( Int sd, struct vk
    return sr_isError(res) ? -1 : sr_Res(res);
...
@@ -1300,7 +1369,7 @@ Int VG_(getpeername) ( Int sd, struct vk
    return sr_isError(res) ? -1 : sr_Res(res);
...
+        || defined(VGP_mips64_linux) || defined(VGP_arm64_linux) || defined(VGO_netbsd)
    ...
    res = VG_(do_syscall3)( __NR_getpeername,
                            (UWord)sd, (UWord)name, (UWord)namelen );
@@ -1341,14 +1410,14 @@ Int VG_(getsockopt) ( Int sd, Int level,
...
+#  elif defined(VGO_darwin) || defined(VGO_netbsd)
    ...
    res = VG_(do_syscall5)( __NR_getsockopt,
                            (UWord)sd, (UWord)level, (UWord)optname, 
@@ -1392,7 +1461,7 @@ Int VG_(setsockopt) ( Int sd, Int level,
                            (UWord)optval, (UWord)optlen );
    return sr_isError(res) ? -1 : sr_Res(res);
